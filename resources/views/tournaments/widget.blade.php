...
@elseif($tournament->id == "150942")
    <div class="round_selector">
        <select name="round" onchange="javascript:updateWidget(150942,this.options[this.selectedIndex].value);">
            ...
            <option selected="" value="7535">Todos contra todos/Fecha 24</option>
...
@elseif($tournament->id == "150943")
    <div class="round_selector">
        <select name="round" onchange="javascript:updateWidget(150943,this.options[this.selectedIndex].value);">
            ...
            <option selected="" value="7573">Todos contra todos/Fecha 22</option>
...
@elseif($tournament->id == "150944")
    <div class="round_selector">
        <select name="round" onchange="javascript:updateWidget(150944,this.options[this.selectedIndex].value);">
            ...
            <option selected="" value="7613">Todos contra todos/Fecha 22</option>
