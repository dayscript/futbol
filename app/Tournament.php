...
//        return $this->hasMany( 'Dayscore\Opta\Game' )->orderBy('date','desc');
    ...
    public function updatewidget()
    {
        ...
        if($this->id=="150946"){ // Champions
            ...
            Storage::disk('s3')->put('/resultswidget/150942_7532.txt',$content);
            Storage::disk('s3')->setVisibility('/resultswidget/150942_7532.txt', 'public');
            ...
            Storage::disk('s3')->put('/resultswidget/150943_7570.txt',$content);
            Storage::disk('s3')->setVisibility('/resultswidget/150943_7570.txt', 'public');
